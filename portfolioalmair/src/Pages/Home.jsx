...
function Home() {
  return (
    <div className="w-full h-screen px-6 lg:px-50 py-10 font-figtree">
      <Navbar />
      <div className="bg-blue-500 w-full h-[90%] mt-5 p-5 md:p-10 bg-cover bg-center bg-[url('/bam.JPG')] flex flex-col justify-end items-end text-end  text-white text-2xl font-bold">
        <a
          href="
